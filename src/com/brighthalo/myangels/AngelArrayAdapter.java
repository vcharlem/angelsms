...
public class AngelArrayAdapter extends ArrayAdapter<Angel>{
	private Context context;
	public AngelArrayAdapter(Context context, int textViewResourceId) {
	    super(context, textViewResourceId);
	    this.context = context;
	}

	public AngelArrayAdapter(Context context, int resource, List<Angel> items) {
